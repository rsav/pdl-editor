...
public class ParenthesisContentExpressionDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ParenthesisContentExpressionDialog(TreeMap<String,Expression> me, MapComboBoxModel mce, JComboBox ce, TreeMap<String,PDLParameter> mp) {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(newName.isEmpty()) {
					JOptionPane.showMessageDialog(getContentPane(),"No name entered. Cannot create ParenthesisContentExpression","Error",JOptionPane.ERROR_MESSAGE);
				} else {
					...
					if(nameUsed==false) {
						...
						System.out.println("DEBUG ParenthesisContentExpressionDialog.okButton: Creating new ParenthesisContentExpression:");
						System.out.println("DEBUG ParenthesisContentExpressionDialog.okButton: expression="+newExpression);
						System.out.println("DEBUG ParenthesisContentExpressionDialog.okButton: power="+newPowerExpression);
						System.out.println("DEBUG ParenthesisContentExpressionDialog.okButton: operation="+newOperation);
							
						// create the new expression of type ParenthesisContent
						ParenthesisContent newExp = new ParenthesisContent()
						...
						System.out.println("DEBUG ParenthesisContentExpressionDialog.okButton: Adding new expression to mapExps");
